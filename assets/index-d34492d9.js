...
`).filter(r => r.length > 0).map(r => [parseInt(r.substring(0, 4), 16), parseInt(r.substring(5, 9), 16)]);
	...
	γ = {
		read(t, e) {
			return (t.getUint8(e) << 24) | (t.getUint8(e + 1) << 16) | (t.getUint8(e + 2) << 8) | t.getUint8(e + 3);
			},
		length: 4
	}, δ = {
		read(t, e) {
			return (t.getUint8(e + 3) << 24) | (t.getUint8(e + 2) << 16) | (t.getUint8(e + 1 << 8) | t.getUint8(e);
			},
		length: 4
	}, S = {
        read(t, e) {
...
const $t = P({
    ...
    jt = P({
        ...
        pokeEvtNum: S,
        itemEvtNum: S,
        pokeAnimatedSmallImg: g(2, l(32, 24)),
        unused: _(1536),
...
function Ce(t) {
    ...
    return {
        c() {
            e = T("div"), n = T("div"), a = T("p"), a.textContent = "Drag & drop EEPROM image here", r = B(), o = T("p"), o.textContent = "OR", i = B(), u = T("input"), c = B(), s = T("p"), s.textContent = "OR", d = B(), f = T("button"), f.textContent = "v5, Load Eloeri's EEPROM image from GitHub", p = B(), R = T("p"), R.innerHTML = '<a href="https://github.com/mamba2410/reverse-pokewalker/blob/master/dumps/bin/64k-full-rom.bin">(this one)</a>', L(u, "type", "file"), L(n, "id", "overlay-box"), L(n, "class", "svelte-1lmrwby"), L(e, "id", "overlay"), L(e, "class", "svelte-1lmrwby")
        },
        m(le, Ye) {

...
`).filter(r => r.length > 0).map(r => [parseInt(r.substring(0, 4), 16), parseInt(r.substring(5, 9), 16)]);
    ...
    length: 4
		...
		read(t, e) {
			return (t.getUint8(e + 3).padStart(2, '0') + t.getUint8(e + 2).padStart(2, '0') + t.getUint8(e + 1).padStart(2, '0') + t.getUint8(e).padStart(2, '0')).toUpperCase();
		},
		length: 4
	}, S = {
        read(t, e) {
